...
import { PlateOrder, RecipeHistory } from 'src/app/bootstrap/models/models'
import { DaoPlateService } from 'src/app/domains/admin/services/dao-plate.service'
import { DaoRecipeHistoryService } from 'src/app/domains/recipe/services/dao-recipe-history.service'
import { PlateDetailComponent } from 'src/app/domains/waiter/components/plate-detail/plate-detail.component'
...
export class DomiciliosListComponent implements OnInit {
  ...
  constructor(
    ...
    private daoDomi: DaoDeliveryService
  ) {}
  ...
  getWaiterInfo() {
    ...
    //   this.waiter = res
    //   if (this.waiter?.role == AUTH_ROLE.ADMIN) this.isAdmin = true
    // })
  }
