...
import { ClientAddress, OrderTemplate, PlateOrder, Recipe } from 'src/app/bootstrap/models/models'
...
import { DaoPriceService } from 'src/app/domains/admin/services/dao-price.service'
...
export class ClientCheckoutComponent implements OnInit {
  ...
  getClient() {
    ...
    //   if (res) {
    //     this.waiter = res
    //     if (res.role !== AUTH_ROLE.DELIVERY) {
    //       this.hasClientAccess = true
    //     }
    //     if (res.role == AUTH_ROLE.ADMIN) {
    //       this.chooseOrderType("delivery")
    //       this.orderType = "delivery"
    //     }
    //     if (res.role == AUTH_ROLE.WAITER) {
