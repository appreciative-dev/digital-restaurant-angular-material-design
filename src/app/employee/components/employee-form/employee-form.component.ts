...
export class EmployeeFormComponent implements OnInit {
  ...
  roles = [
    { title: 'Gerente', role: BUSINESS_ROLE.ADMIN },
    { title: 'Cocinero', role: BUSINESS_ROLE.CHEF },
    { title: 'Mesero', role: BUSINESS_ROLE.WAITER },
    { title: 'Domiciliario', role: BUSINESS_ROLE.DELIVERY },
  ]
